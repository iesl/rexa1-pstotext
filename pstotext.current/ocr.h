char *ocr[] = {
  ...
  "%\n",
  "\n",
  "/log { (Q# ) print print () = } def\n",
  "/log2 { (Q# ) print { 100 string cvs print ( ) print } forall () = } def\n",
  "%/logfontinfo { [ currentfont /FontName get 3 -1 roll ] log2 } def\n",
  "%/pdict { { exch == == } forall } def\n",
  "%/keys { { pop == } forall } def\n",
  "\n",
  "%/debuginfo << /callstack 0 array def >> def\n",
  " \n",
  "% /pushfuncall {\n",
  "%   //debuginfo begin\n",
  "%     [\n",
  "%       exch               % enclose arg in our new array\n",
  "%       callstack aload pop\n",
  "%     ]\n",
  "%     /callstack exch def\n",
  "%   end\n",
  ...
  "% /popfuncall {\n",
  "%   //debuginfo begin\n",
  "%     callstack 1 callstack length 1 sub getinterval\n",
  "%     /callstack exch def\n",
  "%   end\n",
  "% } def\n",
  "\n",
  "% /showcallstack {\n",
  "%   (callstack:) log\n",
  "%   debuginfo /callstack get { log } forall\n",
  "% } def\n",
  "\n",
  "% /saveLastShowCall {\n",
  "%   % string funcname [can't consume string arg!]\n",
  "%   1 index\n",
  "%   //debuginfo begin\n",
  "%     /lastshowstring exch def\n",
  "%     /lastshowcall exch def\n",
  "%   end\n",
  "% } def\n",
  "\n",
  "% /showLastShowCall {\n",
  "%   //debuginfo begin\n",
  "%     [ lastshowcall lastshowstring ] log2\n",
  "%   end\n",
  "% } def\n",
  "\n",
  "% % index array\n",
  "% /isValidArrayIndex {\n",
  "%   (isValidArrayIndex) pushfuncall\n",
  "%   length\n",
  "%   lt\n",
  "%   popfuncall\n",
  "% } def\n",
  "\n",
  "% /isValidString {\n",
  "%   (isValidString) pushfuncall\n",
  "%   debuginfo /valid true put\n",
  "%   currentfont /Encoding get exch % save Encoding for repeated use\n",
  "%   {\n",
  "%     % encoding char\n",
  "\n",
  "%     dup\n",
  "%     % encoding char char\n",
  "\n",
  "%     2 index isValidArrayIndex not\n",
  "%     { \n",
  "%       debuginfo /valid false put \n",
  "%       pop % char\n",
  "%       exit \n",
  "%     } if\n",
  "\n",
  ...
  "  /x /y /z /braceleft /bar\n",
  "\n",
  "  % if 0x7F through 0x9F are unprintable characters in ISO Latin1 WHY IS\n",
  "  % THIS ARRAY MAPPING *ANY* PostScript glyph names to this range???\n",
  "  % And another problem occurs when a glyph name appears BOTH in this\n",
  "  % range and later on (in a valid Latin1 range), because only the first\n",
  "  % (invalid) mapping is used!!!\n",
  "\n",
  ...
  "  %(characterToReporting) pushfuncall\n",
  ...
  "  %(printCharacterOrigin) pushfuncall\n",
  ...
  "% /printMapEntries {\n",
  "%   () =\n",
  "%   (GlyphName to GlyphIndex) log\n",
  "%   currentfont /Encoding get {\n",
  "%     //standardMap exch\n",
  "%     2 copy known {\n",
  "%       [ 1 index 4 2 roll get ] log2\n",
  "%     } { pop pop } ifelse\n",
  "%   } forall\n",
  "%   () =\n",
  "% } bind def\n",
  ...
  "	}{\n",
  "	  % /CharString might not exist in currentfont!; add a dummy dictionary to stack if it D.N.E.\n",
  "%	  currentfont /CharStrings get\n",
  "	  currentfont /CharStrings known { currentfont /CharStrings get } { 0 dict } ifelse\n",
  "	  currentfont /Encoding get\n",
  "	  0 1 255 {\n",
  "		dup 8 mod 0 eq { () = } if\n",
  "\n",
  "		currentfont /CharStrings known not \n",
  "		{ pop 0 0 \n",
  "		  % FontMatrix CharStrings Encoding 0 0\n",
  "		} { \n",
  "\n",
  ...
  "		//showxy exec\n",
  "	  } for\n",
  "	  % FontMatrix CharStrings Encoding\n",
  ...
  "				% privateDict is open\n",
  "  %(reportMetrics) pushfuncall\n",
  "  currentfont /FontMatrix known not { (warning: currentfont missing FontMatrix) log } if\n",
  "  currentfont /FontType known not { (warning:  currentfont missing FontType) log } if\n",
  "  currentfont /FontType get 3 eq not { \n",
  "    currentfont /CharStrings known not { (warning: non-type 3 font missing CharStrings) log } if\n",
  "    currentfont /Encoding known not { (warning: non-type 3 font missing Encoding) log } if \n",
  "  } if\n",
  "  currentfont /FontBBox known not { (warning: currentfont missing FontBBox) log } if\n",
  "\n",
  ...
  "				% privateDict is open\n",
  "  %(reportEncoding) pushfuncall\n",
  "\n",
  "  % Print new \"e\" directive for currentfont\n",
  "  % printMapEntries % to show the standardMap indexes for each postscript glyph name used in this encoding\n",
  "  (QE ) print\n",
  ...
  "  %(reportFontCreation) pushfuncall\n",
  ...
  "  %(reportSubString) pushfuncall\n",
  "  %debuginfo /laststring 2 index put\n",
  "\n",
  "%   % replace invalid strings with empty string\n",
  "%   dup isValidString not { \n",
  "%     %[ (replacing bad string) 2 index (with empty string) ] log2\n",
  "%     (bad string) log\n",
  "%     %debuginfo /lastfont currentfont put % save current font\n",
  "%     %(default) findfont setfont\n",
  "%     pop ()\n",
  "%     p\n",
  "%     %debuginfo /lastfont get setfont % restore font\n",
  "%   } {\n",
  ...
  "\n",
  "/widthshow { \n",
  "  %(widthshow) pushfuncall\n",
  "  %(widthshow) saveLastShowCall\n",
  "  {4 copy widthshow pop}\n",
  "  //systemdict /pstotextLocalDict get /report get\n",
  "  exec pop pop pop \n",
  "  %popfuncall\n",
  "} bind redef\n",
  "\n",
  "/awidthshow { \n",
  "  %(awidthshow) pushfuncall\n",
  "  %(awidthshow) saveLastShowCall\n",
  "  {6 copy awidthshow pop}\n",
  "  //systemdict /pstotextLocalDict get /report get \n",
  "  exec 5 {pop} repeat \n",
  "  %popfuncall\n",
  "} bind redef\n",
  ...
  "\n",
  "/copypage { \n",
  "  %(copypage) pushfuncall \n",
  "  (QC) = flush copypage \n",
  "  %popfuncall \n",
  "} bind redef\n",
  "\n",
  "/erasepage { \n",
  "  %(erasepage) pushfuncall \n",
  "  (QZ) = flush erasepage \n",
  "  %popfuncall \n",
  "} bind redef\n",
  "\n",
  "/showpage { \n",
  "  %(showpage) pushfuncall \n",
  "  (QP) = flush showpage \n",
  "  %popfuncall \n",
  "} bind redef\n",
  "\n",
  ...
  "\n",
  "\n",
  "% fixfont.ps 1.00, June 8 2004\n",
  "\n",
  "% The URW ghostscript fonts used to have executable FontBBox entries, and\n",
  "% some programs counted on that property. The FontBBox entries were made\n",
  "% literal some time ago, and this broke all the output of those programs.\n",
  "% This routine overrides the findfont operator to modify the fonts it loads\n",
  "% to have executable FontBBox entries.\n",
  "\n",
  "/findfont\n",
  "{\n",
  "  %(findfont) pushfuncall\n",
  "  %dup 100 string cvs log\n",
  "\n",
  "  % name\n",
  "  dup //findfont exec  %% execute the base/original version of findfont\n",
  "\n",
  "  %dup pdict\n",
  "  % save found font dict in debuginfo dict as \"/lastfindfont\"\n",
  "  %dup debuginfo /lastfindfont 3 -1 roll put  \n",
  "  dup /FontBBox known not { \n",
  "    (warning: FontBBox not known!) log\n",
  "    % name font \n",
  "    exch pop \n",
  "  } {\n",
  "    % name font\n",
  "    dup /FontBBox get xcheck %% is FontBBox entry executable?\n",
  "    % name font is_executable_bit\n",
  "    { \n",
  "      % name font \n",
  "      exch pop \n",
  "\n",
  "      %(FontBBox is executable) log \n",
  "    } {\n",
  "      % create a new font from the old one, adding an executable\n",
  "      % FontBBox entry, then replace the old the font with the new one\n",
  "      \n",
  "      % name font\n",
  "      dup length dict \n",
  "      % name font newdict\n",
  "      copy dup dup\n",
  "      % name newfont newfont newfont\n",
  "      /FontBBox get cvx\n",
  "      % name newfont newfont bbox\n",
  "      /FontBBox exch\n",
  "      % name newfont newfont /FontBBox bbox\n",
  "      put \n",
  "      % name newfont\n",
  "      definefont\n",
  "      % font\n",
